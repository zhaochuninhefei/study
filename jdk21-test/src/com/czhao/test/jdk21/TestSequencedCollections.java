...
public class TestSequencedCollections {
    public static void main(String[] args) {
        ...
        // 打印 STRS
        System.out.println(STR."STRS = \{ Arrays.toString(STRS) }");
        for (int i = 0; i < 10; i++) {
    ...
    private void test01(int i) {
        ...
        for (int j = 0; j < i; j++) {
            setNotSquenced.add(STRS[j]);
        }
        System.out.println(setNotSquenced);
    }

    // 定义一个长度为10的String数组类型的常量
    private static final String[] STRS = new String[]{"a3", "b3", "a2", "a1", "a0", "a10", "b1", "b2", "b0", "b10"};
